...
public class EmailService {
    ...
    public void sendAccessRevokedEmail(String to) {
        ...
        String body = "Dear User,\n\nYour 7-day free trial access has been revoked. " +
                ...
                "Best regards,\nAcademic Atelier Team";
        sendEmail(to, subject, body);
    }

    public void sendAccessGrantedEmail(String to) {
        String subject = "Access Granted - Academic Atelier";
        String body = "Dear User,\n\nYour access to the Academic Atelier application has been granted by the administrator. " +
